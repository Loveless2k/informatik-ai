        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 items-center'>
          <motion.div variants={itemVariants}>
            ...
            <h2 className='text-3xl sm:text-4xl md:text-5xl font-bold mb-6 sm:mb-8 text-gray-800 dark:text-white leading-tight'>
              ...
              <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#00B4DB] to-[#48D1CC]'>
            ...
            >
              En InformatiK-AI, fusionamos tecnología de vanguardia con
              experiencia sectorial para crear soluciones que generan resultados
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Nuestro equipo multidisciplinar trabaja para entender tus desafíos
              específicos y desarrollar estrategias personalizadas que aportan
              valor medible y sostenible.
            </motion.p>
            <motion.div
          ...
          >
            ...
            <div className='relative h-[400px] sm:h-[450px] md:h-[500px] w-full rounded-2xl overflow-hidden shadow-xl border border-[#00B4DB]/20 dark:border-[#48D1CC]/20'>
              ...
              <div className='absolute inset-0 flex flex-col items-center justify-center p-8 z-10'>
                ...
                >
                  <svg
                    className='w-12 h-12 text-[#00B4DB] dark:text-[#48D1CC]'
                    fill='none'
                    stroke='currentColor'
                    viewBox='0 0 24 24'
                ...
                >
                  Transformamos ideas en soluciones tecnológicas que potencian
                  la eficiencia y competitividad de tu negocio.
                </motion.p>
              </div>
            </div>
