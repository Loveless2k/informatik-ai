    ...
    >
      ...
      <div className="max-w-7xl relative z-10 mx-auto px-4 sm:px-6">
        ...
        <div className="relative mt-20 pb-12">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 w-1.5 h-24 bg-white/30 dark:bg-white/20 blur-sm animate-pulse-slow rounded-full" style={{animationDuration: '3s'}}></div>

          {procesoSteps.map((step, index) => {
            // Colores diferenciados para cada paso
            const colors = [
              { gradient: 'from-[#00B4DB] to-[#48D1CC]', bg: 'bg-[#E0FBFF]', dark: 'dark:bg-[#00B4DB]/20', border: 'border-[#00B4DB]', text: 'text-[#00B4DB]' },
              { gradient: 'from-[#6366F1] to-[#8B5CF6]', bg: 'bg-[#EEF2FF]', dark: 'dark:bg-[#6366F1]/20', border: 'border-[#6366F1]', text: 'text-[#6366F1]' },
              { gradient: 'from-[#EC4899] to-[#F472B6]', bg: 'bg-[#FCE7F3]', dark: 'dark:bg-[#EC4899]/20', border: 'border-[#EC4899]', text: 'text-[#EC4899]' },
              { gradient: 'from-[#10B981] to-[#34D399]', bg: 'bg-[#ECFDF5]', dark: 'dark:bg-[#10B981]/20', border: 'border-[#10B981]', text: 'text-[#10B981]' },
              { gradient: 'from-[#F59E0B] to-[#FBBF24]', bg: 'bg-[#FEF3C7]', dark: 'dark:bg-[#F59E0B]/20', border: 'border-[#F59E0B]', text: 'text-[#F59E0B]' }
            ];
            ...
            return (
              ...
              >
                ...
                <div className={`md:w-5/12 p-6 ${color.bg} ${color.dark} rounded-xl shadow-sm hover:shadow-md
                  ...
                  <div className="relative z-10">
                    <h3 className={`text-2xl font-bold ${color.text} dark:text-white mb-3 flex items-center`}>
                      <span className="mr-2">{step.title}</span>
                      <span className="text-xs font-normal bg-white dark:bg-gray-700 px-2 py-1 rounded-full text-gray-500 dark:text-gray-300">Paso {index + 1}</span>
                    </h3>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    >
                      ...
                      <span className={`bg-gradient-to-r ${gradientClass} text-transparent bg-clip-text text-2xl transform transition-transform duration-300`}>
                        {activeIndex === index ? '−' : '+'}
                      </span>
                    </button>
        ...
        <div className="mt-20 text-center">
          ...
          >
            ...
            <span className="absolute inset-0 bg-white opacity-0 animate-pulse-slow" style={{animationDuration: '3s'}}></span>
            
            <span className="text-lg relative z-10">¿Tienes Más Preguntas? Contáctanos</span>
