  ...
  return (
    <footer
      className={`relative overflow-hidden ${
        isDarkMode ? 'bg-black text-white' : 'bg-[#007D84] text-white'
      }`}
    >
      {/* Abstract shapes in background */}
      <div className='absolute inset-0 overflow-hidden opacity-5'>
        <div
          className={`absolute -top-24 -right-24 w-96 h-96 rounded-full filter blur-3xl ${
            isDarkMode ? 'bg-[#00F0FF]' : 'bg-[#E0FBFF]'
          }`}
        ></div>
        <div
          className={`absolute bottom-1/4 left-1/3 w-80 h-80 rounded-full filter blur-3xl ${
      ...
      <div className='container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10'>
          ...
          <div className='col-span-1 lg:col-span-1 text-center sm:text-left'>
            <div className='flex items-center mb-4'>
              <div
                className={`w-10 h-10 rounded-lg flex items-center justify-center text-white font-bold text-xl mr-2 shadow-md ${
                  isDarkMode
            ...
            <p className='text-gray-300 mb-6'>
              Potenciando empresas con soluciones inteligentes de IA para la
        ...
        <div
          className={`mt-10 sm:mt-12 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center border-t ${
        ...
        >
          ...
          <div className='mt-4 sm:mt-6 md:mt-0'>
            <ul className='flex flex-wrap gap-6 text-sm justify-center'>
              <li>
                <Tooltip
                  text='Información sobre cómo manejamos tus datos'
                  position='top'
                >
                  <Link
                    href='/privacy-policy'
              ...
              <li>
                <Tooltip
                  text='Condiciones de uso de nuestros servicios'
                  position='top'
                >
                  <Link
              ...
              <li>
                <Tooltip
                  text='Información sobre el uso de cookies en este sitio'
                  position='top'
                >
                  <Link
                    href='/cookies'
