...
const DataStreamButton = ({ href, children, className = '' }: DataStreamButtonProps) => {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 ${isDarkMode ? 'bg-secondary/10' : 'bg-secondary/5'} overflow-hidden rounded-full`}>
        {isClient && (
          <motion.div
