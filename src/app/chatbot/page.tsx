...
export const metadata: Metadata = {
  ...generateMetadata({
    ...
    description:
      'Interactúa con nuestro chatbot de inteligencia artificial. Obtén respuestas instantáneas sobre nuestros servicios, consultoría de IA y soluciones tecnológicas.',
    keywords: [
      'chatbot',
      'asistente virtual',
      'IA conversacional',
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>
          <div className='text-center'>
            ...
            <p className='text-lg text-gray-600 dark:text-gray-300'>
              Conversa con nuestro chatbot inteligente para obtener información
        ...
        <div className='flex items-center justify-center h-96 bg-gray-100 dark:bg-gray-800'>
          <div className='text-center'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Para usar nuestro chatbot, por favor habilita JavaScript en tu
              navegador.
            </p>
          </div>
        </div>
