  ...
  return (
    <>
        ...
        >
          <div className="max-w-5xl mx-auto text-center">
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              ¿Tienes preguntas o estás listo para comenzar tu viaje con IA? Nuestro equipo está listo para responder a todas tus consultas.
            </motion.p>
          </div>
        </motion.div>
      </section>
      ...
      <section className={`py-24 ${
        ...
        <div className={`absolute bottom-0 right-1/4 w-1/2 h-1/3 rounded-full filter blur-[120px] ${
          ...
          >
            ...
            <div className="lg:col-span-1">
              <motion.div
                ...
                whileHover={{ y: -5, boxShadow: isDarkMode ? "0 25px 50px -12px rgba(0, 0, 0, 0.5)" : "0 25px 50px -12px rgba(0, 0, 0, 0.1)" }}
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start group">
                    ...
                    <div className="ml-4">
                      ...
                      <p className={`${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>+34 (555) 123-4567</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start group">
                    ...
                    <div className="ml-4">
                      ...
                      <p className={`${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>info@informatik-ai.com</p>
                    </div>
                  </div>
                </div>
          ...
          >
            ...
            >
              ...
              <div className={`relative w-full h-full ${
                ...
                {/* Grid pattern */}
                <div className={`absolute inset-0 ${
                  isDarkMode ? 'bg-grid-white/[0.05]' : 'bg-grid-slate-300/[0.2]'
                } bg-[length:20px_20px]`}></div>

                {/* Digital circuit lines */}
                <div className="absolute inset-0">
                  <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0,50 L1000,50" stroke={isDarkMode ? "#3b82f6" : "#60a5fa"} strokeWidth="0.5" strokeDasharray="10,15" opacity={isDarkMode ? "0.3" : "0.5"} />
                    <path d="M0,150 L1000,150" stroke={isDarkMode ? "#3b82f6" : "#60a5fa"} strokeWidth="0.5" strokeDasharray="10,15" opacity={isDarkMode ? "0.3" : "0.5"} />
                    <path d="M0,250 L1000,250" stroke={isDarkMode ? "#3b82f6" : "#60a5fa"} strokeWidth="0.5" strokeDasharray="10,15" opacity={isDarkMode ? "0.3" : "0.5"} />
                    <path d="M50,0 L50,1000" stroke={isDarkMode ? "#3b82f6" : "#60a5fa"} strokeWidth="0.5" strokeDasharray="10,15" opacity={isDarkMode ? "0.3" : "0.5"} />
                    <path d="M150,0 L150,1000" stroke={isDarkMode ? "#3b82f6" : "#60a5fa"} strokeWidth="0.5" strokeDasharray="10,15" opacity={isDarkMode ? "0.3" : "0.5"} />
                    <path d="M250,0 L250,1000" stroke={isDarkMode ? "#3b82f6" : "#60a5fa"} strokeWidth="0.5" strokeDasharray="10,15" opacity={isDarkMode ? "0.3" : "0.5"} />
                  </svg>
                </div>
          ...
          <div className="max-w-3xl mx-auto mt-16">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  {/* Decoración de fondo */}
                  <div className={`absolute -right-16 -bottom-16 w-32 h-32 bg-gradient-to-br from-[#00B4DB]/10 to-[#48D1CC]/10 rounded-full ${
